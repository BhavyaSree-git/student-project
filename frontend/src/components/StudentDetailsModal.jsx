...
export default function StudentDetailsModal({ studentId, isOpen, onClose, onEditClick, onMarksClick, onAttendanceClick }) {
  ...
  }, [studentId, isOpen, loadDetails])

  return (
    <Modal
      title={details ? `${details.name} - Student Profile` : 'Student Profile'}
      isOpen={isOpen}
      onClose={onClose}
      maxWidth="680px"
    >
